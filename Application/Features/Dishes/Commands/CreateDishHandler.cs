...
public class CreateDishHandler : IRequestHandler<CreateDishCommand, DishResponse>
{
    ...
    public CreateDishHandler(IDishQuery query, IDishCommand command, ICategoryQuery categoryQuery)
    {
        _query = query;
        _command = command;
    ...
    public async Task<DishResponse> Handle(CreateDishCommand command, CancellationToken cancellationToken)
    {
